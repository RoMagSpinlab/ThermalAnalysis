%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RBC Data Analysis for Gamma = 0.5
% 
% Yufan Xu
% RBC is developed from the previous lpMCX. 
...
subplot(5,1,1)
    ...
    title(titlestring0,'interpreter','latex',...
        'fontsize',20);
...
title(titlestring0,'interpreter','latex','fontsize',20);
...
xlabel('$t/t_{ff}$','interpreter','latex','FontSize',18)
set(gca,'fontsize',18,'FontName','Times')
